...
int test_bfm(void)
{
    if (1)
    {
        ...
        src << -17.627, 22.5007, -3.68661,
            17.5639, 23.2431, -4.12958,
            -23.7594, -39.6281, 1.81061,
            24.874, -38.6282, -0.101837;
        tar << -1.11483, -0.414079, 8.10335,
            -0.264147, -0.440271, 8.06141,
            -1.23392, 1.06626, 8.17497,
            -0.132649, 1.00606, 8.08568;

        float scale = 0.0234568;
        Eigen::Matrix3f R;
        R << 0.995377, -0.011744, -0.095321,
            -0.00121295, -0.993954, 0.109793,
            -0.0960341, -0.10917, -0.989373;
        Eigen::RowVector3f t(-0.69818, 0.118927,   8.0507);
        LOG_OUT << (scale * src * R.transpose()).rowwise() + t;
        return 0;
    }
    if (0)
    {
