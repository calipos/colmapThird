...
class Pips(nn.Module):
    ...
    def forward(self, trajs_e0, rgbs, iters=3, trajs_g=None, vis_g=None, valids=None, feat_init=None, is_train=False, beautify=False):
...
class BasicEncoder2(nn.Module):
    def __init__(self, input_dim=3, output_dim=128, stride=8, norm_fn='batch', dropout=0.0):
        ...
        self.conv2 = nn.Conv2d(128+128+96+64, output_dim*2,
...
class Pips_BasicEncoder(nn.Module):
    def __init__(self, stride=8):
        super(Pips_BasicEncoder, self).__init__()
