...
#ifndef CERES_EXAMPLES_FK1_REPROJECTION_ERROR_H_
#define CERES_EXAMPLES_FK1_REPROJECTION_ERROR_H_
#include <vector>
#include <numeric>
...
namespace ba {
    ...
    struct Fk1ReprojectionError {
        Fk1ReprojectionError(double observed_x, double observed_y)
        ...
        static ceres::CostFunction* Create(const double observed_x,
            ...
            return (new ceres::AutoDiffCostFunction<Fk1ReprojectionError, 2, 2, 6, 3>(new Fk1ReprojectionError(observed_x, observed_y)));
        }
    ...
    struct Fk1ReprojectionErrorWithQuaternions {
        Fk1ReprojectionErrorWithQuaternions(double observed_x, double observed_y)
            : observed_x(observed_x), observed_y(observed_y) {}
        ...
        static ceres::CostFunction* Create(const double observed_x,
            const double observed_y) {
            return (
                new ceres::AutoDiffCostFunction<Fk1ReprojectionErrorWithQuaternions,
                2,
                2,
                7,
                3>(
                    new Fk1ReprojectionErrorWithQuaternions(observed_x,
                        observed_y)));
        }
