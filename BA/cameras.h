...
{ 
	struct Camera
	{
		...
		Camera(const double& fx_ = 0, const double& fy_ = 0, const double& cx_ = 0, const double& cy_ = 0, const int& height_ = 0, const int& width_ = 0, const std::vector<double>* distoCoeff_ = nullptr);
	};
